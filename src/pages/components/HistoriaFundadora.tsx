...
export function HistoriaFundadora() {
  return (
    <section id="historia" className="relative w-full py-24 px-6 md:px-10 lg:px-20 bg-white dark:bg-background-dark">
      <div className="max-w-[1200px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative order-2 lg:order-1">
            ...
            <div className="w-full aspect-[4/5] rounded-2xl overflow-hidden bg-slate-200 dark:bg-slate-800 border-4 border-slate-900 shadow-2xl">
          ...
          <div className="flex flex-col gap-6 order-1 lg:order-2">
            ...
            <div className="space-y-4 text-slate-600 dark:text-slate-300 leading-relaxed">
              <p>
                <strong className="text-slate-900 dark:text-white">Soy Andrea Becerra, fundadora de VISIÓN 360.</strong> Mi trayectoria en marketing y publicidad me ha enseñado una verdad fundamental: no existen negocios perdidos, solo estrategias agotadas.
              </p>
              <p>
